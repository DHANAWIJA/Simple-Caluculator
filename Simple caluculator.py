...
input_frame = Frame(win, width=312, height=50, bd=0, highlightbackground="black",highlightthickness=7)

input_frame.pack(side=TOP)



input_field = Entry(input_frame, font=('arial', 20, 'bold'), textvariable=input_text, width=50, bg="grey", bd=10,
                    justify=RIGHT)
...
clear = Button(btns_frame, text="AC", fg="black", width=32, height=3, bd=1, bg="light blue", cursor="hand2",
               command=lambda: bt_clear()).grid(row=0, column=0,columnspan=3,padx=1, pady=1)



divide = Button(btns_frame, text="/", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
...
multiply = Button(btns_frame, text="*", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
...
minus = Button(btns_frame, text="-", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
...
plus = Button(btns_frame, text="+", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
...
point = Button(btns_frame, text=".", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
               command=lambda: btn_click(".")).grid(row=4, column=2, padx=1, pady=1)

equals = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="light blue", cursor="hand2",
